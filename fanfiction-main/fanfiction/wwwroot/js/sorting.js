...
function filter()
{
    filterFunction(document.getElementById("fandom-select").selectedIndex, document.getElementById("countOfNotSortRows").value)
}


function filterFunction(columnNumber, countOfNotSortRows) {
    ...
    for (i = 1; i < tr.length - countOfNotSortRows; i++) {
